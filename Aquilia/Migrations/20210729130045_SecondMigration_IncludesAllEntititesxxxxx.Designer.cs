...
namespace Aquilia.Migrations
{
    ...
    [Migration("20210729130045_SecondMigration_IncludesAllEntititesxxxxx")]
    partial class SecondMigration_IncludesAllEntititesxxxxx
    {
            ...
            modelBuilder.Entity("Aquilia.Models.DebitCredit", b =>
                {
                    ...
                    b.HasOne("Aquilia.Models.FinalProduct", "FinalProduct")
                        .WithOne("DebitCredit")
                        .HasForeignKey("Aquilia.Models.DebitCredit", "FinalProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
